...
// //     feedback: " The professionalism and technical expertise that Eze Israel brought to our project were outstanding. He took our static design and brought them to life with seamless animations and flawless responsiveness.I highly recommend him for any front-end job. ",
...
// //     feedback:"From the very first meeting, Eze Israel understood our vision and translated it into a stunning, user friendly interface. The redesign not only improved aesthetic but also enhanced the overall user experience. Truly a pleasure to work with!' ",
...
// //     name: 'Michael Green',
// //     role: 'CEO of EcoShop',
// //     feedback:"Eze Israel is not just a talented front-end developer but also a fantastic collaborator.He maintained clear communication throughout the project, ensuring all of our feedback was implemented promptly. His ability to adapt made the entire process incredible smooth, I look forward to working together again.",
...
// //     feedback:"We hit multiple roadblocks during production, but Eze Israel tackled each issue head-on with innovative solutions. His attention to detail and technical knowledge saved us time ad elavated the final product. It's rare to find someone with such blend of creativity and technical skills. I highly recommend him for any challenging project.",
...
// //     <section
// //     id='testimonies'
// //     className='shadow-xl border border-2 border-white py-4'
// //     >
// //     <SectionTitle
// //     title='Testimonials' />

// //     <p className='text-center text-2xl'>What the clients says about me.</p>
...
// //         <div className='bg-white shadow-lg  overflow-hidden p-6 flex flex-col md:flex-row'>
